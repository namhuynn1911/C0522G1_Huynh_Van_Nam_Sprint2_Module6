...
insert into product (name, image, date_of_manufacture, price, promotion, content, producer_id, product_type_id, is_delete) values ('Yonex Voltric Lindan 3', 'https://shopvnb.com/uploads/images/tin_tuc/vot-cau-long-yonex-ld-force-2019-1.webp', '2022-09-29', 500000, 'giảm giá 30%', 'Công nghệ hiện đại nhất cho dòng vợt hiện nay, được tuyển thủ Lindan sử dụng thường xuyên', 1, 1, 0);
