...
insert into user (username, password, is_delete) values ('user', '$2a$10$pZNW3zOtmMXwvWeWmRZYxeSbhRKvZE20dxWKQIX2SGlOTXKCBGfJC', 0);


-- add customer
insert into customer (id, name, gender, email, address, phone_number, username, id_card, day_of_birth, is_delete) values (1, 'Huỳnh Văn nam', 1, 'namhuynh191193@gmail', 'Quảng Nam', '0909850091', 'user', '578856430', '1993-11-19', 0);
insert into customer (id, name, gender, email, address, phone_number, username, id_card, day_of_birth, is_delete) values (2, 'Nguyễn Văn phúc', 1, 'phuc@gmail', 'Nghệ An', '0909850091', 'admin', '578856430', '1998-11-19', 0);
